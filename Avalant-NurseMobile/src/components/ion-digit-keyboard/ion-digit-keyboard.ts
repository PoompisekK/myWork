...
export class IonDigitKeyboard {
    ...
    @Output() private buttonClick: EventEmitter<any> = new EventEmitter();
    @Output() private leftActionClick = new EventEmitter();
    @Output() private rightActionClick = new EventEmitter();
    @Output() private numberClick: EventEmitter<any> = new EventEmitter();
    ...
    @HostBinding('class.visible') @Input() private visible: boolean = true;
    @Input() private roundButtons: boolean = false;
    @Input() private showLetters: boolean = true;
    @Input() private swipeToHide: boolean = true;
    @Input() public resize: string = undefined; // @TODO: Implement content resizing
    ...
    public static isShow(): boolean {
        return this.component && this.component.visible == true;
    }

    public static isHide(): boolean {
        return this.component && this.component.visible == false;
    }
     ...
     * @memberOf IonDigitKeyboard
     */
    public static destroy(callback: Function = (success: boolean) => { }): void {
        if (this.component) {

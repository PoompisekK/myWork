...
export class CheckInOut {
    ...
    private displayText = {
        ...
        nameButtonCheckInOut: this.hcmTranslationService.translate('M_CHECK_INOUT.CHECK_IN', 'Check In')
    };
    ...
    private initPage() {
        ...
        if (this.statusCheckInOut == this.TIME_IN) {
            ...
            this.displayText = {
                ...
                nameButtonCheckInOut: this.hcmTranslationService.translate('M_CHECK_INOUT.CHECK_OUT', 'Check Out')
            };
        }
    }
